        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Ask questions about the Xandeum network</p>
            </div>
          </div>
          {messages.length > 0 && (
            <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {EXAMPLE_QUESTIONS.map((q, i) => (
                  <button
                    ...
                    className="text-left p-4 bg-white border border-gray-200 rounded-xl hover:border-purple-300 hover:bg-purple-50 transition group"
                  >
          ...
          <div className="flex gap-4">
            <div className="flex-1 relative">
              <input
                ...
                disabled={loading}
                className="w-full px-5 py-4 pr-14 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent disabled:bg-gray-50 disabled:cursor-not-allowed"
              />
            </div>
            <button
              onClick={() => handleSend()}
              disabled={!input.trim() || loading}
              className="px-6 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl hover:from-purple-700 hover:to-indigo-700 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {loading ? (
